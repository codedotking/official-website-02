...
export default function TeamMembers() {
  return (
    <>
      ...
      <div className="team-section all-members section-margin">
        <div className="container">
          <div className="row mb-n30">
            <div className="col-lg-3 col-md-6 col-sm-6 col-12 mb-30 team-wrapper">
              {/* Single Team Wrapper Start */}
              <div
                className="single-team wow fadeIn"
                data-wow-duration="1.5s"
                data-wow-delay=".1s">
